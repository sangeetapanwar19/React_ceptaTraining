                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">{text.temprature}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Temprature Min</h5>
                            <p class="card-text">{text.temprature_min}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Temprature Max</h5>
                            <p class="card-text">{text.temprature_max}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
